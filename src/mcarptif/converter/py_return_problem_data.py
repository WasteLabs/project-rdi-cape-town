...
"""
import os
import mcarptif.converter.py_data_read as py_data_read  # From Dev_LancommeARPconversions
from mcarptif.converter.py_return_raw_data import return_raw_data as rraw
import pickle
...
def return_nearest_neighbour_data(problem_set, filename, problem_path=None):
    ...
    if problem_path is None:
        problem_path = (
            return_path() + problem_set + "/nearest_neighbour_list/" + filename
        )
    else:
        problem_path = (
            problem_path + problem_set + "/nearest_neighbour_list/" + filename
        )
