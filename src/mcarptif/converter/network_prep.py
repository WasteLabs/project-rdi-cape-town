...
import os
import tables as tb
# import src.mcarptif.converter.shortest_paths as shortest_paths
...
class ShortestPathNodes:
    ...
    def calc_shortest_path_pytable(self,
        ...
        node_id_order = np.array(list(self.G.nodes))
        ...
        with tb.open_file(path, 'w') as h5file:
            ...
            h5file.create_array(sp_info, "node_id_order", node_id_order, "SP order for graph node ids")
