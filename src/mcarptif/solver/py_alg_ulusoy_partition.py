...
import mcarptif.solver.alg_Ulusoy_part_c as c_alg_Ulusoy_part
...
class UlusoysIFs_1vehicle(object):
    ...
    def improve_ifs_all_routes(self, solution_list, if_pre_arcs):
        ...
        for i, route_i in enumerate(solution_list):
            ...
            for j in range(1,nIfs): combined_route += route_i[if_pre_arcs[i][j-1]+2:if_pre_arcs[i][j]+1] 
