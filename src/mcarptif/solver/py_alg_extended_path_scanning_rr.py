...
import mcarptif.solver.evaluatesolutions as evaluatesolutions

from copy import deepcopy
from math import ceil

from mcarptif.solver.py_solution_test import test_solution  # From Dev_SolutionOperators
import mcarptif.solver.py_solution_stats as py_solution_stats
import mcarptif.solver.c_alg_extended_path_scanning_rr as c_alg_extended_path_scanning

from mcarptif.converter.py_return_problem_data import (
    return_problem_data,
)  # From Dev_TestData
import mcarptif.solver.py_solution_builders as build_solution
import os

from mcarptif.solver.py_reduce_number_trips import Reduce_Trips
...
from mcarptif.solver.py_alg_ulusoy_partition import UlusoysIFs_1vehicle
...
class EPS_MultipleGiantRoute(ExtendedPathScanning_Operators, TieBreakRules):
    ...
    def __init__(self, info):
        ...
        self.partition = UlusoysIFs_1vehicle(self.info)
        self.disp = display_solution_stats(info)
...
import mcarptif.converter.py_return_problem_data as py_return_problem_data
