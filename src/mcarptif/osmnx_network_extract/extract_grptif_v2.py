...
class NetworkExtract:
    ...
    def extend_required_inverse_arcs(self):
        ...
        # this doesn't work in newest pandas... https://stackoverflow.com/questions/14162723/replacing-pandas-or-numpy-nan-with-a-none-to-use-with-mysqldb/54403705#54403705
    ...
    def extend_prop_info(self):
        ...
        all_index = network.loc[network['geom_id_order'].isin(prop_info_extended['geom_id_order'])][['arc_index', 'geom_id_order']]
    ...
    def deconstruct_solution(self):
        ...
        routes['u_index-v_index'] = routes['u_index'].astype(int).astype(str) + '-' + routes['v_index'].astype(int).astype(str)
        ...
        network_plot['u_index-v_index'] = network_plot['u_index'].astype(int).astype(str) + '-' + network_plot['v_index'].astype(int).astype(str)

        travel_paths = pd.concat(filler_frames)

        travel_paths = travel_paths.merge(network_plot[['u_index-v_index', 'geometry', 'length', 'maxspeed', 'u', 'v', 'arc_index']], how='left')
